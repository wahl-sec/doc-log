...
def test_type_check_pep257_style_invalid_mixed_passive():
...
def test_type_check_epytext_style_invalid_mixed_passive():
...
def test_type_check_rest_style_invalid_mixed_passive():
...
def test_type_check_google_style_invalid_mixed_passive():
    def _test_func(i: int, j: int) -> int:
        """Function that adds two numbers and returns the result.
...
def test_type_check_numpydoc_style_invalid_mixed_passive():
    def _test_func(i: int, j: int) -> int:
        """Function that adds two numbers and returns the result.
